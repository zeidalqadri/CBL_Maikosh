...
// Import module data
import { moduleData } from '../../data/modules/m8-data';

export default function Module8() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 8);
  ...
  return (
    <ModuleLayout moduleNumber={8} moduleName="Basic Skills - Dribbling" theme="dribbling">
      <Head>
        <title>Module 8: Basic Skills - Dribbling | alloui by CBL</title>
        <meta name="description" content="Develop effective dribbling techniques and learn how to teach ball control to players with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 8: Basic Skills - Dribbling | alloui by CBL" />
        <meta property="og:description" content="Develop effective dribbling techniques and learn how to teach ball control to players with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 8: Basic Skills - Dribbling - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 8: Basic Skills - Dribbling | alloui by CBL" />
        <meta name="twitter:description" content="Develop effective dribbling techniques and learn how to teach ball control to players with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball dribbling, dribbling techniques, ball control, basketball fundamentals, coaching dribbling, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 8: Shooting & Rebounding! This module will teach you the biomechanics of 
              proper shooting technique and rebounding fundamentals to maximize scoring efficiency and 
              second-chance opportunities.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Master all five major shot types - set shot, lay-up, jump shot, hook shot, and free throw - 
              along with defensive and offensive rebounding techniques. These skills are essential for 
              creating and capitalizing on scoring opportunities.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>MABA Focus:</strong> Proper shooting biomechanics include body balance, aiming, 
                shooting action, and follow-through. Master these four fundamentals for consistent results.
              </p>
            </div>
          </div>
        </>
