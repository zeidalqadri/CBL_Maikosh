...
// Import module data
import { moduleData } from '../../data/modules/m7-data';

export default function Module7() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 7);
  ...
  return (
    <ModuleLayout moduleNumber={7} moduleName="Basic Skills - Rebounding" theme="rebounding">
      <Head>
        <title>Module 7: Basic Skills - Rebounding | alloui by CBL</title>
        <meta name="description" content="Master fundamental rebounding techniques and positioning essential for basketball coaching with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 7: Basic Skills - Rebounding | alloui by CBL" />
        <meta property="og:description" content="Master fundamental rebounding techniques and positioning essential for basketball coaching with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 7: Basic Skills - Rebounding - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 7: Basic Skills - Rebounding | alloui by CBL" />
        <meta name="twitter:description" content="Master fundamental rebounding techniques and positioning essential for basketball coaching with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball rebounding, rebounding techniques, basketball fundamentals, coaching rebounding, basic skills, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 7: Dribbling Skills! This module will teach you effective dribbling 
              techniques and help you understand when and how to use different types of dribbles 
              in game situations.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Master the biomechanics of dribbling and learn various techniques from controlled dribbles 
              for protection to speed dribbles for advancement. Understanding proper technique and situational 
              use helps players maintain ball control while staying heads-up.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Key Principle:</strong> Dribble with purpose - to advance the ball, drive to the hoop, 
                get open for a shot, or escape pressure. Avoid over-dribbling that kills team flow.
              </p>
            </div>
          </div>
        </>
