...
// Import module data
import { moduleData } from '../../data/modules/m4-data';

export default function Module4() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 4);
  ...
  return (
    <ModuleLayout moduleNumber={4} moduleName="Fouls & Official Signals" theme="officiating">
      <Head>
        <title>Module 4: Fouls & Official Signals | alloui by CBL</title>
        <meta name="description" content="Learn about different types of fouls and the official signals used by referees with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 4: Fouls & Official Signals | alloui by CBL" />
        <meta property="og:description" content="Learn about different types of fouls and the official signals used by referees with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 4: Fouls & Official Signals - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 4: Fouls & Official Signals | alloui by CBL" />
        <meta name="twitter:description" content="Learn about different types of fouls and the official signals used by referees with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball fouls, official signals, referee signals, basketball officiating, coaching fouls, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 4: Fouls & Official Signals! This module will teach you about physical 
              contact violations and the official hand signals used by referees to communicate 
              decisions during games.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Learn to distinguish between different types of fouls - from personal fouls like charging and 
              blocking to technical and flagrant fouls. Understanding referee signals helps you communicate 
              effectively with officials and teach players proper game conduct.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Key Distinction:</strong> Fouls involve physical contact between players, while 
                violations are rule infractions without contact. Knowing the difference is essential.
              </p>
            </div>
          </div>
        </>
