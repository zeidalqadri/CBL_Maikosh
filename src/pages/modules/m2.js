...
// Import module data
import { moduleData } from '../../data/modules/m2-data';

export default function Module2() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 2);
  ...
  return (
    <ModuleLayout moduleNumber={2} moduleName="Rules & Player Positions" theme="rules">
      <Head>
        <title>Module 2: Rules & Player Positions | alloui by CBL</title>
        <meta name="description" content="Master the official rules and understand the roles of each position on the court with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 2: Rules & Player Positions | alloui by CBL" />
        <meta property="og:description" content="Master the official rules and understand the roles of each position on the court with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 2: Rules & Player Positions - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 2: Rules & Player Positions | alloui by CBL" />
        <meta name="twitter:description" content="Master the official rules and understand the roles of each position on the court with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball rules, player positions, basketball fundamentals, coaching rules, court positions, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 2: Rules & Player Positions! This module will teach you the official 
              basketball rules and help you understand the unique roles and responsibilities of each 
              position on the court.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Master the fundamentals that every coach needs to know: team composition, scoring systems, 
              and how each of the five positions contributes to team success. You'll learn how position 
              characteristics align with player strengths and game strategy.
            </p>
            <div className="bg-alloui-gold bg-opacity-10 border-l-4 border-alloui-gold p-4 rounded">
              <p className="text-alloui-primary dark:text-alloui-gold">
                <strong>Key Focus:</strong> Understanding the game's structure and each position's role 
                is fundamental to effective coaching and player development.
              </p>
            </div>
          </div>
        </>
