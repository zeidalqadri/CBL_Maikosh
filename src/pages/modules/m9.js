...
// Import module data
import { moduleData } from '../../data/modules/m9-data';

export default function Module9() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 9);
  ...
  return (
    <ModuleLayout moduleNumber={9} moduleName="Defense Fundamentals" theme="defense">
      <Head>
        <title>Module 9: Defense Fundamentals | alloui by CBL</title>
        <meta name="description" content="Master defensive strategies, positioning, and fundamentals essential for basketball coaching with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 9: Defense Fundamentals | alloui by CBL" />
        <meta property="og:description" content="Master defensive strategies, positioning, and fundamentals essential for basketball coaching with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 9: Defense Fundamentals - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 9: Defense Fundamentals | alloui by CBL" />
        <meta name="twitter:description" content="Master defensive strategies, positioning, and fundamentals essential for basketball coaching with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball defense, defensive fundamentals, coaching defense, basketball strategy, defensive positioning, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 9: Strategy & Tactics! This module will teach you fundamental offensive 
              and defensive strategies that improve team performance and create scoring opportunities 
              on the basketball court.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Learn essential plays like give-and-go and screening, understand fast break principles, 
              and compare man-to-man versus zone defense systems. These tactical concepts help coaches 
              develop effective game plans and teach strategic thinking.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Strategic Focus:</strong> Great teams execute fundamental plays perfectly rather 
                than complex systems poorly. Master the basics before advancing to complex strategies.
              </p>
            </div>
          </div>
        </>
