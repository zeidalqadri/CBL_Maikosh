...
// Import module data
import { moduleData } from '../../data/modules/m10-data';

export default function Module10() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 10);
  ...
  return (
    <ModuleLayout moduleNumber={10} moduleName="Offense Fundamentals" theme="offense">
      <Head>
        <title>Module 10: Offense Fundamentals | alloui by CBL</title>
        <meta name="description" content="Learn offensive strategies, plays, and fundamentals essential for basketball coaching with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 10: Offense Fundamentals | alloui by CBL" />
        <meta property="og:description" content="Learn offensive strategies, plays, and fundamentals essential for basketball coaching with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 10: Offense Fundamentals - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 10: Offense Fundamentals | alloui by CBL" />
        <meta name="twitter:description" content="Learn offensive strategies, plays, and fundamentals essential for basketball coaching with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball offense, offensive fundamentals, coaching offense, basketball strategy, offensive plays, Malaysia, MABA, NSC, Level I certification" />
      ...
      <div className="mb-8">
        <div className="text-xs text-gray-500 dark:text-gray-400 mb-4 tracking-wider uppercase">
          10 / COACHING COMMUNICATION & ETHICS
        </div>
      </div>
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 10: Communication & Ethics! This module will teach you effective 
              communication skills and ethical coaching practices essential for building trust 
              and developing positive player-coach relationships.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Learn the difference between verbal and non-verbal communication, master techniques for 
              giving constructive feedback, and understand the Coaches' Code of Conduct. These skills 
              are fundamental to being a positive role model and effective leader.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Communication Fact:</strong> 55% of communication is body language, 38% is tone 
                of voice, and only 7% is the actual words used. Master all three elements.
              </p>
            </div>
          </div>
        </>
