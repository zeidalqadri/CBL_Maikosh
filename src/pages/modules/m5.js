...
// Import module data
import { moduleData } from '../../data/modules/m5-data';

export default function Module5() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 5);
  ...
  return (
    <ModuleLayout moduleNumber={5} moduleName="Basic Skills - Passing" theme="skills">
      <Head>
        <title>Module 5: Basic Skills - Passing | alloui by CBL</title>
        <meta name="description" content="Master fundamental passing skills and techniques essential for basketball coaching with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 5: Basic Skills - Passing | alloui by CBL" />
        <meta property="og:description" content="Master fundamental passing skills and techniques essential for basketball coaching with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 5: Basic Skills - Passing - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 5: Basic Skills - Passing | alloui by CBL" />
        <meta name="twitter:description" content="Master fundamental passing skills and techniques essential for basketball coaching with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball passing, passing skills, basketball fundamentals, coaching passing, basic skills, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 5: Equipment & Court! This module will teach you about basketball equipment 
              specifications, court dimensions, and how to create optimal training environments according to 
              MABA standards.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Learn the official specifications for basketballs, court measurements, and hoop heights for 
              different age groups. Understanding these standards ensures you're coaching with the proper 
              equipment and in regulation environments.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>MABA Standards:</strong> Proper equipment and court setup are fundamental to player 
                development and safety. Age-appropriate specifications promote better skill progression.
              </p>
            </div>
          </div>
        </>
