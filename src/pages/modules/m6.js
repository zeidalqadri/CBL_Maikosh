...
// Import module data
import { moduleData } from '../../data/modules/m6-data';

export default function Module6() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 6);
  ...
  return (
    <ModuleLayout moduleNumber={6} moduleName="Basic Skills - Shooting" theme="shooting">
      <Head>
        <title>Module 6: Basic Skills - Shooting | alloui by CBL</title>
        <meta name="description" content="Master fundamental shooting mechanics and techniques essential for basketball coaching with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 6: Basic Skills - Shooting | alloui by CBL" />
        <meta property="og:description" content="Master fundamental shooting mechanics and techniques essential for basketball coaching with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 6: Basic Skills - Shooting - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 6: Basic Skills - Shooting | alloui by CBL" />
        <meta name="twitter:description" content="Master fundamental shooting mechanics and techniques essential for basketball coaching with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball shooting, shooting mechanics, basketball fundamentals, coaching shooting, shooting techniques, Malaysia, MABA, NSC, Level I certification" />
      ...
      <div className="mb-8">
        <div className="text-xs text-gray-500 dark:text-gray-400 mb-4 tracking-wider uppercase">
          06 / BASIC SKILLS — MOVEMENT & BALL HANDLING
        </div>
      </div>
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 6: Basic Skills - Movement & Ball Handling! This module will teach you the 
              fundamental movement patterns and ball handling skills that form the foundation of all 
              basketball techniques.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Master the essential skills every player needs: proper balance, stopping techniques, pivoting, 
              and ball handling fundamentals. These skills create the foundation for all advanced basketball 
              movements and techniques.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Foundation First:</strong> Balance is the foundation of all movement in basketball. 
                Master these fundamentals before advancing to complex skills.
              </p>
            </div>
          </div>
        </>
