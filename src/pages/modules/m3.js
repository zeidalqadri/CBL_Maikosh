...
// Import module data
import { moduleData } from '../../data/modules/m3-data';

export default function Module3() {
  const { user } = useAuth();
  const { progress, saveQuizScore, saveAssessmentSubmission } = useProgress(user?.uid, 3);
  ...
  return (
    <ModuleLayout moduleNumber={3} moduleName="Violations" theme="violations">
      <Head>
        <title>Module 3: Violations | alloui by CBL</title>
        <meta name="description" content="Understand basketball violations and how to teach players to avoid them with alloui by CBL." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Module 3: Violations | alloui by CBL" />
        <meta property="og:description" content="Understand basketball violations and how to teach players to avoid them with alloui by CBL." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Module 3: Violations - alloui by CBL" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Module 3: Violations | alloui by CBL" />
        <meta name="twitter:description" content="Understand basketball violations and how to teach players to avoid them with alloui by CBL." />
        <meta name="twitter:image" content="/icons/twitter-card.png" />
        <meta name="twitter:creator" content="@CBLcoaching" />
        
        {/* SEO meta */}
        <meta name="keywords" content="basketball violations, basketball rules, coaching violations, basketball fundamentals, Malaysia, MABA, NSC, Level I certification" />
        ...
        <>
          ...
          <div className="brand-card mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Welcome to Module 3: Violations! This module will teach you about basketball rule infractions 
              that don't involve physical contact. You'll learn to identify common violations and teach 
              players how to avoid them during games.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Understanding violations is crucial for coaches - from ball handling infractions like traveling 
              and double dribbling to time restrictions and court violations. This knowledge helps you teach 
              clean, fundamentally sound basketball.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
              <p className="text-blue-800">
                <strong>Important Note:</strong> Unlike fouls, violations result in the ball being awarded 
                to the opposing team. Teaching players to avoid violations prevents easy turnovers.
              </p>
            </div>
          </div>
        </>
