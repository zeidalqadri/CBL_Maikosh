...
export default function LoginPage() {
  const { user, loading, signInWithGoogle, signin, error } = useAuth();
  ...
  return (
    <MainLayout>
      <Head>
        <title>Sign In | alloui by CBL</title>
        <meta name="description" content="Sign in to access your basketball coaching certification modules and track your progress." />
        ...
        {/* Social cards */}
        <meta property="og:title" content="Sign In | alloui by CBL" />
        <meta property="og:description" content="Sign in to access your basketball coaching certification modules." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="alloui by CBL" />
        <meta property="og:image" content="/icons/og-image.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Sign In | alloui by CBL" />
        <meta name="twitter:description" content="Sign in to access your basketball coaching certification modules." />
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300">
              Sign in to continue your coaching certification journey
            </p>
          </div>
          ...
          <div className="brand-card p-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link href="/auth/signup" className="font-medium text-alloui-gold hover:text-alloui-gold/80">
                  Create one here
                </Link>
              </p>
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                <Link href="/auth/forgot-password" className="font-medium text-alloui-gold hover:text-alloui-gold/80">
